  ...
  for(i = 0; i < data->ndests; i++)
    {
      ...
      //      if(DEBUG_OUTPUT){
      //  fprintf(stderr,"copy const into key:\t");
      //  fprintf(stderr,"%x %x :\t",cval&0x01,data->dests[i]+st->base);
