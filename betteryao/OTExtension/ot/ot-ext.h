...
/*
void InitAESKey(AES_KEY_CTX* ctx, uint8_t* keybytes, uint32_t numkeys, crypto* crypt);

void fillRndMatrix(uint8_t* seed, uint64_t** mat, uint64_t cols, uint64_t rows, crypto* crypt);

void initRndMatrix(uint64_t*** mat, uint64_t cols, uint64_t rows);

void freeRndMatrix(uint64_t** mat, uint32_t nrows);

void BitMatrixMultiplication(uint8_t* resbuf, uint64_t resbytelen, uint8_t* invec, uint32_t inveclen, uint64_t** matrix, uint64_t* tmpbuf);
*/

inline void InitAESKey(AES_KEY_CTX* ctx, uint8_t* keybytes, uint32_t numkeys, crypto* crypt) {
...
inline void BitMatrixMultiplication(uint8_t* resbuf, uint64_t resbytelen, uint8_t* invec, uint32_t inveclen, uint64_t** matrix, uint64_t* tmpbuf) {
