#ifndef BETTERYAOEVL_H_
#define BETTERYAOEVL_H_
...
class BetterYaoEvl : public BetterYao5
{
public:
	BetterYaoEvl(EnvParams &params);
	virtual ~BetterYaoEvl() {}
